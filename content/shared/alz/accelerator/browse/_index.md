...
![Role assignments for the managed identity used for the plan workflow](/shared/alz/accelerator/browse/id-alz-mgmt-uksouth-plan-001_permissions.png)
...
![Federated workload credential for the managed identity used for the plan workflow](/shared/alz/accelerator/browse/id-alz-mgmt-uksouth-plan-001_oidc.png)
...
![Role assignments for the managed identity used for the apply workflow](/shared/alz/accelerator/browse/id-alz-mgmt-uksouth-apply-001_permissions.png)
...
![OpenID Connect federated credential for the managed identity used for the apply workflow](/shared/alz/accelerator/browse/id-alz-mgmt-uksouth-apply-001_oidc.png)
...
![Custom role definitions used by the managed identities](/shared/alz/accelerator/browse/custom_roles.png)
...
![Azure resources for the private runners](/shared/alz/accelerator/browse/private_runners.png)
...
![The two repositories, alz-mgmt and alz-mgmt-templates, created by the accelerator](/shared/alz/accelerator/browse/repos.png)
...
![Branch protection on the main branch of the alz-mgmt repo](/shared/alz/accelerator/browse/branch_protection_rules.jpg)
...
![Environments configuration](/shared/alz/accelerator/browse/environments.png)
...
![Environment rules for the apply environment](/shared/alz/accelerator/browse/environment_rules.jpg)
...
![Environment and repo level variables used in the GitHub Actions workflows](/shared/alz/accelerator/browse/variables.png)
...
![Private runners in GitHub Actions](/shared/alz/accelerator/browse/github_actions-private_runners.png)
...
You can now run the two GitHub Actions workflows if you wish. They should complete successfully without deploying anything as your Terraform config is essentially empty.

It is now ready for you to build up an Azure Landing Zone or Sovereign Landing Zone configuration using the Azure Verified Modules in the Terraform Registry.
