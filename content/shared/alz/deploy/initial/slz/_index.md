...
1. the policy_default_values now includes `"allowed_locations" = jsonencode({ value = [${var.location}]})` as this array of region shortcodes is expected by the additional archetypes
