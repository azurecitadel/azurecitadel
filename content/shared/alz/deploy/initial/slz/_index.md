...
## Sovereign Landing Zone library release
...
1. Also update the semantic version constraint at the top for alz

    The versions can be seen on the [ALZ provider's documentation](https://registry.terraform.io/providers/Azure/alz/latest/docs). Add a constraint in to the required_provider's object in the terraform block.
