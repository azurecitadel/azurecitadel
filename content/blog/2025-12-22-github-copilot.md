...
As part of my day job I am often working with the newer technologies and I need to make sure that my references are fully up to date. I will integrate with the Microsoft Learn MCP server to make sure that is the case, rather than relying on potentially stale training data.
...
Copilot did have the history of the session to draw from

### Corrections

The second paragraph in the intro was written by me. I added it to explain why the MCP server had value.
...
- I switched th install command from `npm install -g @githubnext/github-copilot-cli` to `npm install -g @github/copilot@latest`.
